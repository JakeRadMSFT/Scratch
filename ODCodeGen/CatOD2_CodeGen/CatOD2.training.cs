...
namespace CatOD2_CodeGen
{
    public partial class CatOD2
    {
     public const string RetrainFilePath = @"C:\dev\datasets\StopSignSmall\Stop\StopSign-export.json";
     ...
     // <summary>
        ...
        private static IEnumerable<ModelInput> LoadFromVott(string inputDataFilePath)
        {
            ...
            foreach (KeyValuePair<string, JsonNode> asset in jsonNode["assets"].AsObject())
            {
                ...
                var imagePath = MLImage.CreateFromFile(asset.Value["asset"]["path"].GetValue<string>().Replace("file:", ""));
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Labels",inputColumnName:@"Labels",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.Transforms.ResizeImages(outputColumnName:@"Image",inputColumnName:@"Image",imageHeight:600,imageWidth:800,cropAnchor:ImageResizingEstimator.Anchor.Center,resizing:ImageResizingEstimator.ResizingKind.IsoPad))      
